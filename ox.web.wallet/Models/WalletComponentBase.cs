...
{
    public abstract class WalletComponentBase : StatesComponentBase
    {
        protected WalletWebBox Box;
        ...
        {
            Box = WebBox.GetWebBox<WalletWebBox>();


            this.OnWalletInit();
        }
        protected abstract void OnWalletInit();
