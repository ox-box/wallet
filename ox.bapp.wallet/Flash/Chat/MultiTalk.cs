...
{
    public partial class MultiTalk : DarkDocument, INotecaseTrigger, IModuleComponent
    {
        public Module Module { get; set; }
        protected INotecase Operater;
        Tuple<UInt256, MulticastTalkLineValue> TP;

        MulticastChatbox chatbox;
        MulticastChatboxInfo cbi;
        ...
        public MultiTalk(INotecase notecase, Tuple<UInt256, MulticastTalkLineValue> tp)
            : this()
        {
            ...
            if (FlashMessageProvider.Instance.MulticastTalkLines.TryGetValue(tp.Item1, out MulticastTalkLineValue mtlv))
            {
                ...
                if (walletAccount.IsNotNull() && !walletAccount.WatchOnly)
                {
                    ...
                    chatbox = new MulticastChatbox(this.Operater, cbi);
