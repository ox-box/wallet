...
namespace OX.Wallets
{
    ...
    public static class RequestExtensions
    {
        ...
        public static bool IsMobileBrowser(this IHttpContextAccessor httpaccesor)
        {
            var state = httpaccesor?.HttpContext?.Request?.GetUserAgent();
            return state.IsNotNull() && state.IsMobile;
        }
        public static UserAgentStatus GetUserAgent(this HttpRequest request)
        {
            UserAgentStatus status = new UserAgentStatus { };
        ...
        {
            return request.Path.HasValue && (request.Path.Value.ToLower().StartsWith("/_pc") || request.Path.Value == "/");
        }
    ...
    class CheckMobileBrowser
    {
        ...
        public CheckMobileBrowser(RequestDelegate next)
        {
            _next = next;
        }
    ...
    public static class CheckMobileBrowserMiddlewareExtension
    {
        public static IApplicationBuilder UseCheckMobileBrowser(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<CheckMobileBrowser>();
        }
    }
}
