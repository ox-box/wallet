...
namespace OX.Wallets.Mnemonics
{
    public static class Mnemonic
    {
        ...
        public static byte[] SeedToPrivateKey(byte[] seed, int coinType)
        {
            ...
            var paymentKey = ExtKey.CreateFromSeed(seed).Derive(derivePath);
        ...
        public static string SeedToWPF(byte[] seed, int coinType)
        {
            ...
            var account = new OX.Wallets.KeyPair(SeedToPrivateKey(seed, coinType));
