...
namespace OX.Wallets.UI.Controls
{
    public class DarkRadioButton : RadioButton
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var borderColor = SpecialBorderColor.HasValue ? SpecialBorderColor.Value : Colors.LightText;
            var fillColor = SpecialFillColor.HasValue ? SpecialFillColor.Value : Colors.LightestBackground;
            if (Enabled)
            {
                if (Focused)
                {
