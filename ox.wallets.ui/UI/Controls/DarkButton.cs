...
namespace OX.Wallets.UI.Controls
{
    ...
    public class DarkButton : Button
    {
        ...
        public Color? SpecialTextColor { get; set; } = null;
        public Color? SpecialBorderColor { get; set; } = null;
        public Color? SpecialFillColor { get; set; } = null;
        #endregion
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var textColor = SpecialTextColor.HasValue ? SpecialTextColor.Value : Colors.LightText;
            var borderColor = SpecialBorderColor.HasValue ? SpecialBorderColor.Value : Colors.GreySelection;
            var fillColor = SpecialFillColor.HasValue ? SpecialFillColor.Value : (_isDefault ? Colors.DarkBlueBackground : Colors.LightBackground);
